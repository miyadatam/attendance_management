    ...
    <div class="page-header">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">早出申請編集</li>
        </ol>
      </nav>
    </div>
    <div class="row">
      <div class="col-lg-8 grid-margin stretch-card mx-auto">
        <div class="card">
          <div class="card-body">
            ...
            <form :action="earlyTimeAction(pending_earlytime.id)" method="post" class="mt-3" id="form" ref="form">
              <input type="hidden" name="_token" :value="csrfToken()">
              <input type="hidden" name="_method" value="PUT">
              <div class="form-row">
                <div class="form-group col-sm-6">
                  <label for="start-at">開始時間</label>
                  <input type="time" name="start_at" class="form-control" id="start-at" :value="pending_earlytime.start_at">
                </div>
                <div class="form-group col-sm-6">
                  <label for="end-at">終了時間</label>
                  <input type="time" name="end_at" class="form-control" id="end-at" :value="pending_earlytime.end_at">
                </div>
              </div>
              <div class="form-group">
                <label for="memo">備考</label>
                <textarea name="memo" class="form-control" id="memo" :value="pending_earlytime.memo" placeholder="申請理由"></textarea>
              </div>
            </form>
...
export default {
  props: ['date', 'start_at', 'end_at',  'pending_earlytime'],
  mixins: [Data, Link],
  data(){
    return {
      'is_error': false
